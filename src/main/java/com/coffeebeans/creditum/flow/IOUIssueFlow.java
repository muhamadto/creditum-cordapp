...
import static com.coffeebeans.creditum.contract.IOUContract.Commands.*;
...
/**
 * This is the flow which handles issuance of new IOUs on the ledger. Gathering the counterparty's signature is handled by the
 * [CollectSignaturesFlow]. Notarisation (if required) and commitment to the ledger is handled by the [FinalityFlow]. The flow returns the
 * [SignedTransaction] that was committed to the ledger.
 */
public class IOUIssueFlow {
  ...
  /**
   * This is the flow which signs IOU issuances. The signing is handled by the [SignTransactionFlow].
   */
